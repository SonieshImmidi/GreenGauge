...
const ARTICLES = [
  {
    id: 1, category: 'climate', icon: '🌡️', tag: 'Climate Change',
  ...
  {
    id: 2, category: 'energy', icon: '☀️', tag: 'Renewable Energy',
  ...
  {
    id: 3, category: 'food', icon: '🌱', tag: 'Green Living',
  ...
  {
    id: 4, category: 'recycling', icon: '♻️', tag: 'Recycling',
  ...
  {
    id: 5, category: 'climate', icon: '🌡️', tag: 'Climate Change',
  ...
  {
    id: 6, category: 'energy', icon: '☀️', tag: 'Renewable Energy',
  ...
  {
    id: 7, category: 'recycling', icon: '♻️', tag: 'Recycling',
  ...
  {
    id: 8, category: 'food', icon: '🌱', tag: 'Green Living',
    ...
    return (
      <div className="animate-fade-in" style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div className="glass-card" style={{ padding: '36px 32px' }}>
          <span style={{ background: `${selected.color}18`, color: selected.color, border: `1px solid ${selected.color}30`, padding: '4px 12px', borderRadius: 'var(--radius-full)', fontSize: '0.78rem', fontWeight: 600 }}><EmojiIcon emoji={selected.icon} size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />{selected.tag}</span>
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, marginTop: 16, marginBottom: 12 }}>{selected.title}</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: 24 }}><EmojiIcon emoji="⏱️" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 4 }} />{selected.read} read</p>
          ...
          <div style={{ marginTop: 32, padding: '16px 20px', background: 'rgba(0,255,136,0.06)', borderRadius: 'var(--radius-md)', border: '1px solid rgba(0,255,136,0.15)' }}>
            <p style={{ fontSize: '0.88rem', color: 'var(--text-secondary)', margin: 0 }}>
              <EmojiIcon emoji="💡" size={14} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 4 }} /><strong style={{ color: 'var(--color-primary)' }}>Take Action:</strong> Apply what you've learned and track your progress in the Carbon Calculator.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div style={{
        ...
        <div style={{ fontSize: '3rem', marginBottom: 12 }}><EmojiIcon emoji="📚" size={48} aria-hidden="true" /></div>
      ...
      <div style={{ display: 'flex', gap: 14, marginBottom: 28, flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {CATEGORIES.map((cat) => (
            ...
            >
              {cat === 'all' ? <><EmojiIcon emoji="🌍" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />All</> : cat === 'climate' ? <><EmojiIcon emoji="🌡️" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />Climate</> : cat === 'energy' ? <><EmojiIcon emoji="☀️" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />Energy</> : cat === 'food' ? <><EmojiIcon emoji="🌱" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />Food</> : <><EmojiIcon emoji="♻️" size={13} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 5 }} />Recycling</>}
            </button>
          ))}
        </div>
      </div>
          ...
          {filtered.map((article, i) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
                ...
                }}><EmojiIcon emoji={article.icon} size={11} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 4 }} />{article.tag}</span>
                <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}><EmojiIcon emoji="⏱️" size={11} aria-hidden="true" style={{ verticalAlign: 'middle', marginRight: 3 }} />{article.read}</span>
              </div>
